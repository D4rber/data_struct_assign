...
public class TutorManagementUI {
    ...
    public class InputModule {
        ...
        public static Tutors inputTutorDetails() {
        ...
        public static String inputTutorID() {
            System.out.print("Enter tutor ID: ");
        ...
        public static String inputProgramme() {
            System.out.print("Enter which programme is teaching (RDS2S1G3): ");
            return scanner.nextLine();
        }
    ...
    public static void generateSalaryReport(ListInterface<Tutors> tutorList) {
        int totalSalary = 0;
